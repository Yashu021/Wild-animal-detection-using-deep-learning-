...
def predict_species(image):
    ...
    # Filter predictions to include only animals
...
def open_camera():
    ...
    while True:
        ...
        if predictions:
            ...
            cv2.putText(frame, "No animal detected", (10, 30),
...
def plot_graphs(predictions):
    ...
    plt.title("Line ;Accuracy vs. Loss")
    plt.xlabel("Prediction Rank")
...
# Function to display image and result in GUI
...
def upload_images():
    ...
    for file_path in file_paths:
        ...
        # Check if the uploaded photo is human (not an animal)
        if not predictions:
            ...
            result_text = "Detected: " + ", ".join(detected_animals)
